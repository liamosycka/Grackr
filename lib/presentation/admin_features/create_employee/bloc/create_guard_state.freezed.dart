...
class _$CreateEmployeeStateTearOff {
  const _$CreateEmployeeStateTearOff();
...
// ignore: unused_element
const $CreateEmployeeState = _$CreateEmployeeStateTearOff();
...
abstract class $CreateEmployeeStateCopyWith<$Res> {
  factory $CreateEmployeeStateCopyWith(
      ...
      _$CreateEmployeeStateCopyWithImpl<$Res>;
  $Res call(
      {Name_Surname name,
      Name_Surname surname,
      EmployeeID employeeID,
...
class _$CreateEmployeeStateCopyWithImpl<$Res>
    implements $CreateEmployeeStateCopyWith<$Res> {
  _$CreateEmployeeStateCopyWithImpl(this._value, this._then);

  final CreateEmployeeState _value;
  // ignore: unused_field
  final $Res Function(CreateEmployeeState) _then;
...
class __$CreateGuardStateCopyWithImpl<$Res>
    extends _$CreateEmployeeStateCopyWithImpl<$Res>
...
class _$_CreateGuardState
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CreateEmployeeState(name: $name, surname: $surname, employeeID: $employeeID, employeePermissions: $employeePermissions, currentUser: $currentUser, showErrorMessages: $showErrorMessages, isSubmitting: $isSubmitting, adminFeaturesFailureOrSuccess: $adminFeaturesFailureOrSuccess)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'CreateEmployeeState'))
...
abstract class _CreateGuardState implements CreateEmployeeState {
